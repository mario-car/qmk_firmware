...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [WIN_BASE] = LAYOUT_91_ansi(
        ...
        MC_1,     KC_GRV,   KC_1,     KC_2,     KC_3,     KC_4,     KC_5,      KC_6,     KC_7,     KC_8,     KC_9,     KC_0,     KC_MINS,    KC_EQL,   KC_BSPC,            KC_PGUP,
        MC_2,     LGUI_T(KC_TAB),   KC_Q,     KC_W,     KC_E,     KC_R,     KC_T,      KC_Y,     KC_U,     KC_I,     KC_O,     KC_P,     KC_LBRC,    KC_RBRC,  LGUI_T(KC_BSLS),            KC_PGDN,
        MC_3,     LCTL_T(KC_ESC),  HOME_A,     HOME_S,     HOME_D,     HOME_F,     MT(MOD_HYPR, KC_G),      MT(MOD_HYPR, KC_H),     HOME_J,     HOME_K,     HOME_L,     HOME_SCLN,  KC_QUOT, LCTL_T(KC_ENT), KC_HOME,
        MC_4,     KC_LSFT,            KC_Z,     KC_X,     KC_C,     KC_V,      KC_B,     KC_N,     KC_M,     KC_COMM,  KC_DOT,   KC_SLSH,              KC_RSFT,  KC_UP,
        MC_5,     KC_LCTL,  KC_LWIN,  MO(WIN_FN),  KC_LALT,         KC_LCTL,                        KC_SPC,             RALT_T(KC_F6),  MO(WIN_FN), KC_RCTL,  KC_LEFT,  KC_DOWN,  KC_RGHT),
    ...
    [WIN_FN] = LAYOUT_91_ansi(
        ...
        _______,  _______,  _______,  _______,  _______,  _______,  _______,   _______,  _______,  _______,  _______,  _______,  _______,    _______,  _______,            _______,
        _______,  RGB_TOG,  RGB_MOD,  RGB_VAI,  RGB_HUI,  RGB_SAI,  RGB_SPI,   KC_BSPC,  _______,  _______,  _______,  _______,  _______,    _______,  _______,            _______,
